...
<html><head><title>Disney's Toontown Online Store</title>
<meta http-equiv="imagetoolbar" content="no">
<meta name="description" content="Show your Tooniness by checking out the great t-shirts, hats, and more in the Toontown store!  You can even put your artistic talents to the test by creating your own Toontown inspired gear!">
<meta name="keywords" content="store, purchase, hats, gear, shirts, create, toontown, adventure, personalize, friends, tasks, MMORPG, MMO, MMOG, massively, Internet, online, information, info, happenings, tontown, tooontown, tooon, new, update, disney, fun, games, game, kids, toon, gag, cog, entertainment, children, play">
...
<meta name="agerange" content="ALL">
...
aimhelppopup=window.open("./popups/aimIconsHelp.php?icon="+icon,"aimhelppopup","width=418,height=480,scrollbars=1");
aimhelppopup.focus();
}
//-->
</script>
...
<table width="434" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center"><img src="./store/images/tt_headline_shop.gif" width="424" height="88" alt="Shop! You-Design-It Toontown Tees"></td>
  </tr>
  <tr>
    <td align="center"><a href="http://disneyshopping.go.com/DSSectionPage.process?Merchant_Id=2&Section_Id=11843&Product_Id=193694"><img src="./store/images/tt_DisneyInkshop.gif" width="424" height="224" alt="Create One Now" border="0"></a></td>
  </tr>
  <tr>
    <td align="center"><a href="http://disneyshopping.go.com/DSSectionPage.process?Merchant_Id=2&Section_Id=11843&Product_Id=193694"><img src="./store/images/bydisneyinkshop.gif" width="424" height="10" alt="Brought to you by Disney Inkshop" border="0"></a></td>
  </tr>
  <tr>
    <td align="center"> 
    <br>
...
<table width="424" height="298" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="9">
      <img src="/store/images/auctionitems_head.gif" width="424" height="27" alt="More Toontown Items"></td>
  </tr>
  <tr>
    <td width="1" height="130" bgcolor="#cccc99">
      <img src="/store/images/spacer.gif" width="1" height="130" alt=""></td>
    <td width="17" height="130">
      <img src="/store/images/spacer.gif" width="17" height="130" alt=""></td>
    <td>
      <a href="">
        <img src="" width="100" height="130" border="0" alt=""></a></td>
    <td width="44" height="130">
      <img src="/store/images/spacer.gif" width="44" height="130" alt=""></td>
    <td>
      <a href="">
        <img src="" width="100" height="130" border="0" alt=""></a></td>
    <td width="44" height="130">
  ...
  <tr>
    <td width="1" height="131" bgcolor="#cccc99">
      <img src="/store/images/spacer.gif" width="1" height="131" alt=""></td>
    <td width="17" height="131">
      <img src="/store/images/spacer.gif" width="17" height="131" alt=""></td>
    <td>
      <a href="">
        <img src="" width="100" height="131" border="0" alt=""></a></td>
    <td width="44" height="131">
      <img src="/store/images/spacer.gif" width="44" height="131" alt=""></td>
    <td>
      <a href="">
        <img src="" width="100" height="131" border="0" alt=""></a></td>
    <td width="44" height="131">
  ...
  <tr>
    <td colspan="9">
      <img src="/store/images/auctionitems_foot.gif" width="424" height="10" alt="Brought to you by Disney Auctions"></td>
  </tr>
</table>
  ...
  -->
    ...
    <!--End Mid Content-->
     ...
     <td width="154" rowspan="1" valign="top" align="center">
       ...
       <!--
         flashObj=new FlashObj(
           "/shared/images/flash/topToons.swf?theDate=08292009&amp;topToonURL=/shared/images/dynamic/topToonImages/2009_08_29_small/&amp;imageBaseURL=/shared/images&amp;moreTopToonsURL=./topToons.php&amp;imageFileURL=/dynamic/topToonImages/2009_08_29_small/", // swf
           "154", //width
           "330", // height
           "#ffffff", // background
           "", // version
