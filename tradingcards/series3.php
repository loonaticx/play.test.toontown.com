...
<html><head><title>Disney's Toontown Trading Cards</title>
...
<!--
slideLeft    = new Image; slideLeft.src  = "./tradingcards/images/cogs/C35A.jpg";
slideRight   = new Image; slideRight.src = "./tradingcards/images/cogs/C02A.jpg";

slide1Cogs   = new Image; slide1Cogs.src = "./tradingcards/images/cogs/C01A.jpg";
slide1Fish   = new Image; slide1Fish.src = "./tradingcards/images/fish/F01A.jpg";
slide1Gags   = new Image; slide1Gags.src = "./tradingcards/images/gags/G01A.jpg";
...
function previousImage() {
  ...
  document.images.slideimage.src = slideLeft.src;
  slideLeft.src  = "./tradingcards/images/"+imgPrefix+zeroBuffer(oneLeft)+imgSuffix;
}
function nextImage() {
  oneLeft++;
  oneRight++;
  ...
  slideRight.src = "./tradingcards/images/"+imgPrefix+zeroBuffer(oneRight)+imgSuffix;
}
...
function changeCategory(newCat) {
  switch (newCat) {
    case 'fish':
    {
      ...
      slideLeft.src  = "./tradingcards/images/cogs/C35A.jpg";
      break;
    }
    case 'gags':
    {
...
function popDisclaimer (extUrl) {
  disclaimerWin = window.open("./shared/www/inter_dis_auctions.php?site="+extUrl, 'Legal', 'width=350,height=240');
}
//-->
</script>
...
<table width="434" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><img src="./tradingcards/images/tradingcard_cntr_left.jpg" width="147" height="189" border="0" alt="Trading Cards - Series 3" usemap="#tradingcard_cntr_left_Map"></td>
    <td><img src="./tradingcards/images/cogs/C01A.jpg" width="135" height="189" alt="Series 3 Trading Card" name="slideimage" id="slideimage" border="0"></td>
    <td><img src="./tradingcards/images/tradingcard_cntr_rgt.jpg" width="152" height="189" border="0" alt="Trading Cards - Series 3" usemap="#tradingcard_cntr_rgt_Map"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <a href="javascript:popDisclaimer('http://www.adobe.com/products/acrobat/readstep2.html');"><img src="/shared/images/get_adobe_reader.gif" width="88" height="31" alt="Get Adobe Reader" border="0"></a> <br>
...
<area shape="poly" alt="Print a Checklist" coords="126,24, 166,9, 250,9, 296,24, 296,37, 250,52, 162,52, 126,37" href="javascript:popChecklist('./tradingcards/images/toontown_tradingcards_s3.pdf');">
</map>
...
<area shape="rect" alt="Click to view Fish" coords="286,46,424,148" href="#image" onClick="javascript:changeCategory('fish');">
    ...
    <!--End Mid Content-->
     ...
     <td width="154" rowspan="1" valign="top" align="center">
       ...
       <!--
         flashObj=new FlashObj(
           "/shared/images/flash/topToons.swf?theDate=10072010&amp;topToonURL=/shared/images/dynamic/topToonImages/2010_10_07_small/&amp;imageBaseURL=/shared/images&amp;moreTopToonsURL=./topToons.php&amp;imageFileURL=/dynamic/topToonImages/2010_10_07_small/", // swf
           "154", //width
           "330", // height
           "#ffffff", // background
           "", // version
...
<div id="tt_footer" align="center">
  ...
  <script type="text/javascript">
    ...
    cto.h.pageName='_tradingcards_series3';
    cto.registrationStatus='prospect';
    cto.genre='us';//country
    cto.account='toontown';
    cto.category='dgame';
    cto.site='tnt_beta';
    cto.siteSection='website:tradingcards';
    cto.pageName='series3';
