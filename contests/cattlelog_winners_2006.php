...
<table width="434" cellspacing="0" cellpadding="0" border="0" >
  <tr>
    <td colspan="3" align="center">
      <img src="./contests/images/cattlelog/tt_cattlelog_header.jpg" width="424" height="75" alt="Cattlelog T-Shirt Design Contest Winners!" border="0">
    </td>
  </tr>
  <tr>
    <td colspan="3" align="center">
      <img src="./contests/images/cattlelog/tt_cattlelog_winners.jpg" width="424" height="224" alt="Priscilla S. Age 13 Coconut Creek, F; Clayton G. Age 30 Spenceport, NY; Brittanie L.  Age 11 Everett, WA" border="0">
    </td>
  </tr>  
  <tr>
    <td colspan="3" align="center">
      <img src="./contests/images/cattlelog/tt_cattlelog_text.gif" width="424" height="53" alt="Congratulations to the winners. Stay Tooned for your T-shirts in Clarabelle's Cattlelog!" border="0">
    </td>
  </tr>   
  <tr>
    <td colspan="3" align="center">
      <img src="./contests/images/cattlelog/honorable_mentions.gif" width="424" height="31" alt="Honorable Mentions" border="0">
    </td>
  </tr>
  ...
  <a href="#image"><img src="./contests/images/cattlelog/previous_button.jpg" width="51" height="75" border="0" alt="Previous Image" onClick="previousImage();"></a>
  </td>
    
    <td width="*" align="center">
      <img src="./contests/images/cattlelog/01_runnerup.jpg" width="234" height="213" alt="Runner Up" name="slideimage" id="slideimage" border="0">
    </td>
  
    <td valign="center" align="center" width="100">
      <a href="#image"><img src="./contests/images/cattlelog/next_button.jpg" width="52" height="75" border="0" alt="Next Image" onClick="nextImage();"></a>
    </td>
  </tr>
...
<!-- END MIDDLE CONTENT -->
    ...
    <!--End Mid Content-->
     ...
     <td width="154" rowspan="1" valign="top" align="center">
       ...
       <!--
         flashObj=new FlashObj(
           "../../shared/images/flash/topToons.swf?theDate=04242011&amp;topToonURL=../../shared/images/dynamic/topToonImages/2011_04_24_small/&amp;imageBaseURL=../../shared/images&amp;moreTopToonsURL=./topToons.php&amp;imageFileURL=/dynamic/topToonImages/2011_04_24_small/", // swf
           "154", //width
           "330", // height
           "#ffffff", // background
           "", // version
