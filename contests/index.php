...
<table width="434" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td>
      <a href="./contests/toonfriendsessay/"><img src="./contests/images/TT_toon_friends_essay.jpg" width="424" height="307" border="0" alt="Toon Friends Essay Contest"></a><br>
      <div style="width:434" align="justify">
      Playing with friends is what makes Toontown truly special. You've beaten Cogs together, fished together, raced together, and stormed HQs together! Now you can sing your friends' praises with the Toon Friends Essay Contest! Tell us how Toontastic your Toon friends are in a 100-word essay. Submit your essay between now and April 4th and the top four essays will win a Disney 2.4Ghz Cordless Phone. <a href="./contests/toonfriendsessay/">Click here</a> for Official Rules and details on how to enter! 
      </div>
     </td>
  </tr>
  ...
  <tr>
    <td width="434" align="center" colspan="2">
      <div style="width:434" align="justify">
        ...
        <a href="./contests/doodleappreciation/"><img src="./contests/doodleappreciation/images/TT_doodle_appreciation_winners_sm.jpg" width="200" height="215" alt="Doodle Appreciation Contest Winners" border="0"></a>
         </span>
         <img src="./contests/doodleappreciation/images/TT_doodle_appreciation_winners_sm.gif" width="224" height="49" alt="Doodle Appreciation Contest Winners" border="0"><br>
         Thank you to all of the Toons who submitted Doodle pictures and essays for the Doodle Appreciation Contest! Join us in congratulating the top five Toontastic winning entries -- each has won a Disney Mickey's House Hourglass Snowglobe! <a href="./contests/doodleappreciation/">Click here</a> to see the winning entries.     
      </div>
    </td>
  </tr>
</table>
...
<table width="434" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td>
      ...
      <a href="./contests/valentinepoem2007/">Valentine's Poem Contest Winners</a><br>
      <a href="./contests/toptoons/winners2007.php">Top Toons New Year's Day Marathon 2007</a><br>
      <a href="./contests/holidayart/">Holiday Art Contest Winners!</a><br>
      <a href="./contests/estatephoto/">Estate Photo Contest Winners!</a><br>
      <a href="./contests/grandprix/winners.php">Toontown Grand Prix Weekend Winners</a><br>      
      <a href="./contests/halloweenpoetry/">Halloween Poetry Contest</a><br>
      <a href="./contests/billybudd_contest4.php">Billy Budd's Fishing Tournament</a><br>
      <a href="./contests/summer_essay/winners.php">Summer Vacation Essay Contest</a><br>
      <a href="./contests/40laff_winner_2006.php">40 Laff Contest Winner</a><br>
      <a href="./contests/house_decor/best_house_winners_2006.php">Best Decorated House Contest</a><br>
...
<!-- END MIDDLE CONTENT -->
    ...
    <!-- END MIDDLE CONTENT -->
     ...
     <td width="154" rowspan="1" valign="top" align="center">
       ...
       <!--
         flashObj = new FlashObj(
           "../../shared/images/flash/topToons.swf?theDate=03102008&amp;topToonURL=../../shared/images/dynamic/topToonImages/2008_03_10_small/&amp;imageBaseURL=../../shared/images&amp;moreTopToonsURL=./topToons.php&amp;imageFileURL=/dynamic/topToonImages/2008_03_10_small/", // swf
           "154", //width
           "330", // height
           "#ffffff", // background
           "", // version
