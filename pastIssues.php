...
function popWin (name) {
  if (name == "WHATISGAMECARD") {
    window.open("./popups/gameCardWhatIsMain.php","gamecard","width=700,height=450,resizable=0");
  } else if (name == "GAMECARD") {
    window.open("./popups/gameCardHelpFrameset.html","whatisgamecard","width=518,height=420,resizable=1");
  } 
}
        ...
        <table cellspacing="0" cellpadding="0" border="0">
          <tr>
            <td><img src="./shared/images/weather/weather_blizzard.gif" width="133" height="109" border="0"><br></td>
                      <td><a href="./webHome.php"><img src="./shared/images/hdrCenterLogo.gif" width="516" height="109" alt="" border="0"></a></td>
    ...
    <!-- END HEADER -->
      ...
      <tr>
        ...
        <OBJECT classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"  codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,79,0"  WIDTH="154" HEIGHT="468" id="tt_nav">
         <PARAM NAME="movie" VALUE="./shared/images/flash/tt_nav_prospect.swf?playUrl=javascript:window.location='https://account.test.toontown.com/webWelcome.php';&frontPageUrl=./webHome.php&whatIsTTUrl=./about.php&screenshotsUrl=./screenshots.php&newsArchiveUrl=./newsArchive.php&releaseNotesUrl=./news.php&memberServicesUrl=./unavailableOnTestServer.php&emailPrefUrl=https://account.test.toontown.com/webChangeEmail.php&changePwdUrl=https://account.test.toontown.com/webChangePassword.php&billingInfoUrl=./unavailableOnTestServer.php&chatPrefUrl=https://account.test.toontown.com/webChangeChat.php&faqUrl=./faq.php&reportProblemUrl=./problem.php&exitSignUpUrl=./webHome.php&seetoontownUrl=./screenshots.php&sendCardUrl=http://disney.go.com/dcards/toontown/index.html&">
         <PARAM NAME="quality" VALUE="high">
         <PARAM NAME="bgcolor" VALUE="#FFFFFF">
         <PARAM NAME="base" VALUE="shared/images">
         <PARAM NAME="menu" value="false">
         <EMBED src="./shared/images/tt_nav_prospect.swf?playUrl=javascript:window.location='https://account.test.toontown.com/webWelcome.php';&frontPageUrl=./webHome.php&whatIsTTUrl=./about.php&screenshotsUrl=./screenshots.php&newsArchiveUrl=./newsArchive.php&releaseNotesUrl=./news.php&memberServicesUrl=./unavailableOnTestServer.php&emailPrefUrl=https://account.test.toontown.com/webChangeEmail.php&changePwdUrl=https://account.test.toontown.com/webChangePassword.php&billingInfoUrl=./unavailableOnTestServer.php&chatPrefUrl=https://account.test.toontown.com/webChangeChat.php&faqUrl=./faq.php&reportProblemUrl=./problem.php&exitSignUpUrl=./webHome.php&seetoontownUrl=./screenshots.php&sendCardUrl=http://disney.go.com/dcards/toontown/index.html&" quality=high bgcolor="#FFFFFF"  WIDTH="154" HEIGHT="468" NAME="tt_nav" ALIGN="" TYPE="application/x-shockwave-flash" PLUGINSPAGE="https://www.macromedia.com/go/getflashplayer"></EMBED>
        </OBJECT>
...
<table cellspacing="0" cellpadding="0" border="0" width="434">
 ...
 <tr>
    <td width="224" align="center" valign="top"><p align="justify">
      ...
      <br><img src="./shared/images/subheaders/halloweenHauntings.gif" width="220" height="41" border="0">
      <br>
    ...
    <td width="210" align="center"><br><img src="./shared/images/billboards/halloweenHauntings.jpg" width="200" height="180" border="0"><br>
    </td>
 </tr>
...
<tr><a name="comingsoon">
  <td colspan="2" align="center">
    <img src="./shared/images/comingsoonTXT.jpg" width="253" height="90" alt="" border="0">
  </td>
</tr>
<tr>
  <td colspan="2">
...
<tr><a name="backstage">
  <td colspan="2" align="center">
    <img src="./shared/images/backstageTXT.jpg" width="222" height="90" alt="" border="0" vspace="5">
  </td>
</tr>
<tr>
  <td colspan="2">
...
<!-- END MIDDLE CONTENT -->
    ...
    <!-- END MIDDLE CONTENT -->
        ...
        <td width="154" rowspan="2" valign="top">
          ...
          <PARAM NAME="movie" VALUE="./shared/images/seeTT_Ad.swf?playUrl=javascript:window.location='https://account.test.toontown.com/webWelcome.php';&frontPageUrl=./webHome.php&whatIsTTUrl=./about.php&screenshotsUrl=./screenshots.php&newsArchiveUrl=./newsArchive.php&releaseNotesUrl=./news.php&memberServicesUrl=./unavailableOnTestServer.php&emailPrefUrl=https://account.test.toontown.com/webChangeEmail.php&changePwdUrl=https://account.test.toontown.com/webChangePassword.php&billingInfoUrl=./unavailableOnTestServer.php&chatPrefUrl=https://account.test.toontown.com/webChangeChat.php&faqUrl=./faq.php&reportProblemUrl=./problem.php&exitSignUpUrl=./webHome.php&seetoontownUrl=./screenshots.php&sendCardUrl=http://disney.go.com/dcards/toontown/index.html&">
          <PARAM NAME="quality" VALUE=high>
          <PARAM NAME="bgcolor" VALUE="#FFFFFF">
          <PARAM NAME="base" VALUE="shared/images">
          <PARAM NAME="menu" value="false">
          <EMBED src="./shared/images/seeTT_Ad.swf?playUrl=javascript:window.location='https://account.test.toontown.com/webWelcome.php';&frontPageUrl=./webHome.php&whatIsTTUrl=./about.php&screenshotsUrl=./screenshots.php&newsArchiveUrl=./newsArchive.php&releaseNotesUrl=./news.php&memberServicesUrl=./unavailableOnTestServer.php&emailPrefUrl=https://account.test.toontown.com/webChangeEmail.php&changePwdUrl=https://account.test.toontown.com/webChangePassword.php&billingInfoUrl=./unavailableOnTestServer.php&chatPrefUrl=https://account.test.toontown.com/webChangeChat.php&faqUrl=./faq.php&reportProblemUrl=./problem.php&exitSignUpUrl=./webHome.php&seetoontownUrl=./screenshots.php&sendCardUrl=http://disney.go.com/dcards/toontown/index.html&" quality=high bgcolor="#FFFFFF"  WIDTH="154" HEIGHT="190" NAME="seeTT" ALIGN="" TYPE="application/x-shockwave-flash" PLUGINSPAGE="http://www.macromedia.com/go/getflashplayer"></EMBED>
          </OBJECT><br><br>
          
                      <a href="./unavailableOnTestServer.php" onClick="logit('NAME', 'CLICKTHRU', 'name', 'rightNavPurchaseAd');"><img src="./shared/images/billboards/greatDeals.gif" width="153" height="275" alt="" border="0"></a>          
      ...
      <tr><td colspan="5" align="center"><CENTER>
         ...
         <a href="./memberAgreement.php">Member Agreement</a>&nbsp|&nbsp<a href="http://disney.go.com/guestservices/netiquette.html">House Rules</a>
         <br>
