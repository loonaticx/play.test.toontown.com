...
<html><head><title>Disney's Toontown Screenshots & Video</title>
<meta http-equiv="imagetoolbar" content="no">
<link type="text/css" rel="stylesheet" href="./shared/include/css/global.css">
<meta name="description" content="Check out exciting screenshots taken inside Disney's Toontown Online, and watch videos starring Toons, the cogs, and even a special guest or two.">
<meta name="keywords" content="screen, shots, video, screenshots, images, pictures, graphics, toontown, multiplayer, adventure, gags, laff, points, special, events, personalize, friends, tasks, MMORPG, MMO, MMOG, massively, Internet, online, happenings, tontown, tooontown, tooon, new, update, disney, fun, games, game, kids, toon, gag, cog, entertainment, children, play">
...
function popVideo(url){
  toonVid = window.open (url,'toontownVideo','width=600,height=400');
}
-->
</script>
...
function nextImage() {
  ...
  document.images.screenshot.src="/shared/images/screenshots/screen" + i +".jpg";
...
<table cellspacing="0" cellpadding="0" border="0" width="434">
  <tr>
    <td colspan="3" align="center"><br><img src="/shared/images/headers/screenshots.gif" width="222" height="37" alt="Screenshots" border="0"><br><br></td>
  </tr>
  <tr>
    <td align="center" valign="middle"><a href="#image" onClick="javascript:previousImage();"><img src="/shared/images/arrowLeft.gif" width="48" height="70" alt="Left Arrow" border="0"></a></td>
    <td align="center" valign="middle"><img src="/shared/images/screenshots/screen1.jpg" alt="Screenshot" name="screenshot" id="screenshot" width="337" height="253" border="0"></td>
    <td align="center" valign="middle"><a href="#image" onClick="javascript:nextImage();"><img src="/shared/images/arrowRight.gif" width="48" height="70" alt="Right Arrow" border="0"></a></td>
  </tr>
  <tr>
    <td colspan="3">
      <br>
      <img src="/shared/images/line.gif" height="1" border="0">
    </td>
  </tr>
  <tr>
    <td colspan="3" align="center"><br><img src="/shared/images/headers/video.gif" width="104" height="40" alt="Video" border="0"><br></td>
  </tr>
</table>
...
<table cellspacing="0" cellpadding="0" border="0" width="434">
      ...
      <table cellspacing="0" cellpadding="0" border="0" width="434">
        <tr>
          <td width="45%" align="right">
            <a href="#video" onClick="javascript:popVideo('./video.php?back=on&MOVIETYPE=FLV&MOVIENAME=TT_testimonial_012_Megan_Rally.flv')"><img src="/shared/images/thumbs/testimonials_Megan_Rally.gif" width="141" height="148" border="0" alt="ToonFest Testimonial Megan Rally"></a>
          </td>
          <td width="10%">&nbsp;</td>
          <td width="45%" align="left">
            <a href="#video" onClick="javascript:popVideo('./video.php?back=on&MOVIETYPE=FLV&MOVIENAME=TT_testimonial_011_Eric.flv')"><img src="/shared/images/thumbs/testimonials_Eric.gif" width="141" height="148" border="0" alt="ToonFest Testimonial Eric"></a>
          </td>
        </tr>
      </table>
    </td>
  ...
  <tr>
    <td width="33.3%" align="center">
      <a href="#video" onClick="javascript:popVideo('./video.php?back=on&MOVIETYPE=FLV&MOVIENAME=TT_testimonial_010_JoAnn.flv')"><img src="/shared/images/thumbs/testimonials_JoAnn.gif" width="141" height="148" border="0" alt="ToonFest Testimonial JoAnn"></a>
    </td>
    <td width="33.3%" align="center">
      <a href="#video" onClick="javascript:popVideo('./video.php?back=on&MOVIETYPE=FLV&MOVIENAME=TT_testimonial_009_Ryan.flv')"><img src="/shared/images/thumbs/testimonials_Ryan.gif" width="141" height="148" border="0" alt="ToonFest Testimonial Ryan"></a>      
    </td>
    <td width="33.3%" align="center">
      <a href="#video" onClick="javascript:popVideo('./video.php?back=on&MOVIETYPE=FLV&MOVIENAME=TT_testimonial_008_Goofy_Speedway.flv')"><img src="/shared/images/thumbs/testimonials_Goofy_Speedway.gif" width="141" height="148" border="0" alt="ToonFest Testimonial Goofy Speedway"></a>        
    </td>
  </tr>

  <tr>
    <td width="33.3%" align="center">
      <a href="#video" onClick="javascript:popVideo('./video.php?back=on&MOVIETYPE=FLV&MOVIENAME=TT_testimonial_007_Shelby.flv')"><img src="/shared/images/thumbs/testimonials_Shelby.gif" width="141" height="148" border="0" alt="ToonFest Testimonial Shelby"></a>        
    </td>
    <td width="33.3%" align="center">
      <a href="#video" onClick="javascript:popVideo('./video.php?back=on&MOVIETYPE=FLV&MOVIENAME=TT_testimonial_006_Mary_Blake_Zach.flv')"><img src="/shared/images/thumbs/testimonials_Mary_Blake_Zach.gif" width="141" height="148" border="0" alt="ToonFest Testimonial Mary, Blake &amp; Zach"></a>      
    </td>
    <td width="33.3%" align="center">
      <a href="#video" onClick="javascript:popVideo('./video.php?back=on&MOVIETYPE=FLV&MOVIENAME=TT_testimonial_005_Indiana.flv')"><img src="/shared/images/thumbs/testimonials_Indiana.gif" width="141" height="148" border="0" alt="ToonFest Testimonial Indiana"></a>
    </td>
  </tr>

  <tr>
    <td width="33.3%" align="center">
      <a href="#video" onClick="javascript:popVideo('./video.php?back=on&MOVIETYPE=FLV&MOVIENAME=TT_testimonial_004_Austin2.flv')"><img src="/shared/images/thumbs/testimonial_austin.gif" width="141" height="148" border="0" alt="ToonFest Testimonial Austin"></a>
    </td>
    <td width="33.3%" align="center">
      <a href="#video" onClick="javascript:popVideo('./video.php?back=on&MOVIETYPE=FLV&MOVIENAME=TT_testimonial_003_ChloeM.flv')"><img src="/shared/images/thumbs/Testimonials_chloeM.gif" width="141" height="148" border="0" alt="ToonFest Testimonial Chloe M"></a>      
    </td>
    <td width="33.3%" align="center">
      <a href="#video" onClick="javascript:popVideo('./video.php?back=on&MOVIETYPE=FLV&MOVIENAME=TT_testimonial_002.flv')"><img src="/shared/images/thumbs/Testimonials_video.gif" width="141" height="148" border="0" alt="ToonFest Testimonial Ben A"></a>
    </td>
  </tr>

  <tr>
    <td width="33.3%" align="center">
      <a href="#video" onClick="javascript:popVideo('./video.php?back=on&MOVIETYPE=FLV&MOVIENAME=ToonFest2006Testimonial.flv')"><img src="/shared/images/thumbs/ToonFestTestimonials_video.gif" width="141" height="148" border="0" alt="ToonFest Testimonial Hamuka Family"></a>  
    </td>
    <td width="33.3%" align="center">
      <a href="#video" onClick="javascript:popVideo('./video.php?back=on&MOVIETYPE=FLV&MOVIENAME=ToonFest2006.flv')"><img src="/shared/images/thumbs/toonfest_video.gif" width="141" height="148" border="0" alt="ToonFest 2006 Video"></a>
    </td>
    <td width="33.3%" align="center">
      <a href="#video" onClick="javascript:popVideo('./video.php?back=on&MOVIETYPE=FLV&MOVIENAME=TT_Download.flv')"><img src="/shared/images/thumbs/calling_all_toons.gif" width="141" height="148" border="0" alt="Calling All Toons"></a>  
    </td>
  </tr>

  <tr>
    <td width="33.3%" align="center">
      <a href="#video" onClick="javascript:popVideo('./video.php?back=on&MOVIETYPE=FLV&MOVIENAME=TT_Ever_Wonder_Long.flv')"><img src="/shared/images/thumbs/lifeasatoon.gif" width="141" height="148" border="0" alt="Life as a Toon"></a>
    </td>
    <td width="33.3%" align="center">
      <a href="#video" onClick="javascript:popVideo('./video.php?back=on&MOVIETYPE=FLV&MOVIENAME=TT_Disney_411.flv')"><img src="/shared/images/thumbs/disney411.gif" width="141" height="148" border="0" alt="Toontown Takes Hollywood"></a>    
    </td>
    <td width="33.3%" align="center">
      <a href="#video" onClick="javascript:popVideo('./video.php?back=on&MOVIETYPE=FLV&MOVIENAME=TT_411_grandprix.flv')"><img src="/shared/images/thumbs/disney411_grandprix.gif" width="141" height="148" border="0" alt="Toontown Grand Prix"></a>    
    </td>
  </tr>
