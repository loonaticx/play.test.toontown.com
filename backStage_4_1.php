...
<table cellspacing="0" cellpadding="0" border="0" width="434">
  <tr>
    ...
    <td align="right" class="bold">1 of 1</td>
  </tr>
  <tr>
    <td colspan="2" class="txtSmall">Issue 4, June 18, 2003</td>
  </tr>
  <tr>
    <td colspan="2" align="center"><br><img src="/shared/images/headers/backStage_4.gif" width="384" height="74" alt="" border="0"><br><br></td>
  </tr>
  <tr>
    <td align="center" valign="top">
      ...
      <table width="200" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center">
            <p align="justify">   
              This issue of Backstage puts the focus on fishing! Once just a relaxing easy way to pass time in the playground, fishing will now require precision and expertise -- not to mention gadgets aplenty and bonus healing power! <br><br>
              Our artists are designing a whole slew of new creatures to swim in the ponds. Models are currently being built for some of the new fish species. Once a fish has been caught, you can choose whether to throw it back in the water or take it to your estate to keep as a pet. You will even be able to take a dip with your new fishy friends.<br><br>
              <img src="/shared/images/TTBS_graphic_04_01.jpg" width="200" height="156" alt="" border="0">
              <br><br>
              We are considering making fishing a bit of a game in itself, so that your fishing skills will sharpen with practice. The more you fish, the better you get. Just like the ice cream cones, catching fish will heal you faster after a challenging Cog encounter.<br><br>
          </td>
        </tr>
      </table>
      <!-- END COLUMN 1 -->
    ...
    <td align="center" valign="top">
      ...
      <table width="200" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center">
            <p align="justify">
              <img src="/shared/images/TTBS_graphic_04_02.jpg" width="200" height="214" alt="" border="0">
              <br><br>
              ...
              <br><br>
              As always, we are continuing to try to make Toontown as rich and entertaining as it can be. We hope you are having as much fun playing in Toontown as we are building it! <br><br>
  ...
  <tr>
    <td colspan="2" align="center"><a href="./newsArchive.php">Look at past issues</a></td>
  </tr>
</table>
<!-- END MIDDLE CONTENT -->
