...
{
  setTargetURL('ACTIVEXINITFAIL',    './ActiveXproblem.php');
  setTargetURL('HARDWARECHECKFAIL',  './missedRequirements.php');
  setTargetURL('HARDWARECHECKOK',    './test/hasHardware.php');
  setTargetURL('GRAPHICSCHECKFAIL',  './graphicsDrivers.php');
  setTargetURL('REPORTPROBLEM',      './reportBug.php?reportproblem=1');
  setTargetURL('GAMEFAIL',           './reportBug.php?reportproblem=0');
  ...
  setTargetURL('PURCHASE',           './unavailableOnTestServer.php');
}
...
function installerExit()
{
  ...
  if (initialized) {
      ...
      && deployment == 'US' )
    {
      ...
      httpReq.open("GET", "./services/sendIncompleteDownload.php", true);
      httpReq.send(null);
    } else {
