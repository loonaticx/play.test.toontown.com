...
<table cellspacing="0" cellpadding="0" border="0" width="434">
  ...
  <tr>
    <td>
      ...
      <b>February 24, 2009 [sv1.0.38.9.test]</b>
<ul>
<li><b>Fixed issue with launching the ActiveX game client (red "PLAY" button on homepage or orange Toon dog desktop icon).</b>
<li>Made visual improvements to Party Clock.
<li>Fixed Parties bug which caused the trampoline GUI to remain on screen even after the party has ended and your Toon has been teleported back to the playground.
<li>Fixed crash bug which sometimes occur when interacting with your Mailbox.
<li>Fixed a few exit crash bugs related to Parties.
<li>Fixed bug which did not properly deduct the amount of JellyBeans spent planning a Party if the Toon left the game unexpectedly before the Party planning had completed.
<li>Made a change to the Jukebox in Parties so when your song is about to begin you will be informed via Whisper.
</ul>
<br>

<b>February 19, 2009 [sv1.0.38.8.test]</b>
<ul>
<li><b>Fixed bug causing Boarding Group panels to not appear in boarding areas.
<li>Fixed Boarding Group related server crash bug.
<li>Fixed bug which caused a crash when you exit the game.  You will properly go back to Pick-A-Toon now.</b>
<li>Fixed "GO" button on Boarding Group leader's panel so it is no longer active after the group boards an elevator.
<li>Fixed bug which caused Toons who left a Boarding Group to become stuck in the boarding area as if they were still in the group.
<li>Free Players will no longer be able to form or join Boarding Groups.
<li>Fixed crash bug which occurs when a Boarding Group member has the Shticker Book open as the leader boards an elevator.
<li>Toons booted out of a Boarding Group can only be invited back by the Boarding Group leader.
<li>Fix a few other Boarding Group related crashes.
<li>Made minor visual improvements to Calendar page in Shticker Book.
<li>Parties listings now show total number of activities, with consolidated listings of multiple items (ie. Trampoline x 4).
<li>Fixed Parties bug where offline friends invited to the party were not actually recorded by the server.
<li>Fixed Parties crash bug which sometimes occurs when a Party ends.
<li>Fixed Parties bug which gave a refund to Toons when their parties start.
<li>The list of Public Parties will now list parties with the most Toons and activities at the top.
<li>Fixed bug where the Party On button in the Shticker Book's Parties page did not become active for an attendee after the host starts the party.
<li>Fixed issue which allowed Toons to remain in a Party after it has ended and the host has already been teleported back to the playground.
<li>Fixed minor Parties bug where one could schedule a party in the past so long as it is the same day.
</ul>
<br>

<b>February 10, 2009 [sv1.0.38.7.test]</b>
<ul>
<li>Fixed bug which allowed a Boarding Group leader to press the "GO" button on the Boarding Group GUI after the group has boarded an elevator/golf kart.
<li>Fixed bug which caused change in Party status to sometimes not be properly reflected (started, ended, changed between Private and Public).
<li>Fixed server crash resulting from Party Cannon scores higher then 100.
<li>Fixed issue with Party Host name sometimes not properly fitting the sign under the Party Clock.
</ul>
<br>

<b>February 09, 2009 [sv1.0.38.6.test]</b>
<br><br>
<b>Attention TEST Toons!</b>
<br><br>
The wait is over!  Let the Parties begin!
<ul>
<li>Toons may only host one party at a time
<li>Once a party is scheduled it cannot be changed (date/time, activities etc), except for making a private party public.
<li>Private parties are invite only (and one can only invite Friends in current Friends List).  Public parties are open to all comers up to a limit, and the list of public parties are available at any Party Gate entrance.
<li>Cancelling a planned party will only refund 95% of the cost, so plan wisely!
</ul>
Please let us know what you think of this new feature, and tell us of any issues or bugs via <a href="./reportBug.php">Report A Bug</a>
<br> 
<br>

<b>February 06, 2009 [sv1.0.38.5.test]</b>
<ul>
<li>Fixed crash bug which occurs when one Toon enters a CogHQ elevator and another Toon enters the same area thru the door.
<li>Fixed missing texture on seltzer bottle gag.
</ul>
<br>

<b>February 04, 2009 [sv1.0.38.4.test]</b>
<ul>
<li>Fixed several crash bugs related to Boarding Group.
<li>Changed Boarding Group behavior: Now if you are part of a Boarding Group and you try to leave the boarding area (via Teleport, Door, or Elevator) you will be warned that you cannot.  You must leave your current Boarding Group before leaving the boarding area.
<li>Fixed issue with regards to Minnie and sleep-walking Donald walking through or too near the new Party Gates.
<li>Fixed a rare crash which could occur when a Toon tries to go to his/her Estate.
</ul>
<br>

<b>February 01, 2009 [sv1.0.38.3.test]</b>
<ul>
<li>Fixed crash bug which occurs when a Boarding Group boards an elevator or golf kart (BossbotHQ) while group members are near by.  This bug caused everyone within the vicinity to crash out.  Please test this and let us know if it is still occurring.
</ul>
<br>

<b>January 30, 2009 [sv1.0.38.2.test]</b>
<ul>
<li>Fixed bug which caused Boarding Group panel to stay up after leaving a Boarding Group.
<li>Changed the behavior of Boarding Group invite so that you can only deal with a single request (send or receive) at a time.
<li>Fixed several crash bugs related to Boarding Group.
</ul>
<br>

<b>January 28, 2009 [sv1.0.38.1.test]</b>
<br><br>
<b>Attention Test Toons!</b>
<br><br>
We have a brand new feature for you to help us test: Boarding Groups!
<br><br>
Toons can use this feature to organize into elevator Boarding Groups in CogHQ areas, making it easier to get onto an elevator for a Factory run or for taking on a BossCog!  Just click on another Toon while inside any CogHQ areas near an elevator, and invite them to form a Boarding Group!
<br><br>
Please let us know what you think of this new feature, and be sure to report any bugs or issues you may find to <a href="./reportBug.php">Report A Bug</a> page!
<br><br>
<b>*** NOTE ***</b>
<br><br>
There is currently a bug with the Boarding Group GUI panel such that if you leave a group it will not disappear as it should.  However this will not stop you from accepting a new invitation to another group.  This bug will be fixed upon next release.
<br>
<br>
<hr>

<b>January 06, 2009 [sv1.0.37.10.test]</b>
<ul>
...
<b>January 03, 2009 [sv1.0.37.9.test]</b>
<ul>
<li>Made minor tweaks to the Type Chat sound on/off option in the Shticker Book's "Options" tab.
</ul>
<br>

<b>December 30, 2008 [sv1.0.37.8.test]</b>
<ul>
<li>Toons now have a way to turn Type Chat sounds on/off via a new option in the Shticker Book's "Options" tab.  Type Chat speech sounds are defaulted to "on", so when you type chat now you will hear your own Toon and other Toons' meow's and growl's!  If you switch Type Chat sounds to "off", you will no longer hear your own Toon nor other Toons.  <br><br>SpeedChat phrases will continue to have sounds and is unaffected by this new feature.
</ul>
<br>

<b>December 28, 2008 [sv1.0.37.7.test]</b>
<ul>
<li>This is a maintenance release.
</ul>
<br>

<b>December 24, 2008 [sv1.0.37.6.test]</b>
<ul>
<li>Fixed an issue where the chat buttons could disappear from the game window in some circumstances.
<li>Fixed a bug where a Free Player Toon who clicks on the Whisper Panel's blue Type Chat button will bring up the Features Panel instead of the Whisper Type Chat box.
<li>Fixed thought bubbles so they will not disappear on their own.
</ul>
<br>

<b>December 18, 2008 [sv1.0.37.5.test]</b>
<ul>
<li>This is a maintenance release.
</ul>
<br>

<b>December 17, 2008 [sv1.0.37.4.test]</b>
<ul>
<li>Fixed missing tower top from Toon HQ buildings found in Donald's Dock.
</ul>
<br>

<b>December 16, 2008 [sv1.0.37.3.test]</b>
<ul>
<li>Fixed bug which prevented Type Chat Whispers from working properly if two Toons were not within the same game area.
<li>Fixed graphics bug with the ToonHQ water tower top.
<li>Changed wording on some panels that appear if the blue Type Chat button is clicked and certain conditions are true, such as the setting of no SpeedChat Plus nor Open Chat with True Friends.
</ul>
<br>

<b>December 10, 2008 [sv1.0.37.2.test]</b>
<ul>
<li>Added Winter Holiday related items to the Cattlelog.  Be sure to check out all the <u>hot</u> new items Clarabelle has for sale!
<li>Fixed many issues related to SpeedChat Plus behavior and disappearing Chat buttons/input box. Please keep letting us know what you think of the new feature!
<li>Fixed bug in Treasure Dive trolley game where the Bear Acuda's collision area was too large, making it too easy for a diving Toon to get hit.
<li>Fixed crash which occurs when you hit the F2 key inside the Factory/Mint/DA's Office.
<li>Fixed issue with moving around while Type Chat input box is open.
</ul>
<b>*** PLEASE NOTE ***</b>
<br>
Be sure to adhere to the <a href="http://home.disney.go.com/guestservices/netiquette">Disney House Rules</a> while testing SpeedChat Plus! We are still adding functionality, so please send any comments, bug reports, or word suggestions to us through the <a href="http://apps.disneyblast.go.com/cgi-bin/mail/generic_mail.cgi?template=toontown/toonhelp.tpl">Contact Us</a> form.
<br>
<br>
<br>

<b>December 05, 2008 [sv1.0.37.1.test]</b>
<br><br>
<b>Attention Test Toons!</b>
<br><br>
...
<br><br>
<b>What is SpeedChat Plus:</b>
<ul>
<li>SpeedChat Plus is a form of type chat that allows users to communicate by using the Disney SpeedChat Plus dictionary. Words that are not in the dictionary will be highlighted in red. You then have the opportunity to choose alternative words prior to sending your message. 
</ul>
<b>How do I enable SpeedChat Plus:</b>
<ul>
<li>SpeedChat Plus, along with your other chat options, is managed through the <u>Preferences</u> section of Member Services. Click <a href="https://account.test.toontown.com/webChangeChat.php" target="_blank">here</a> to go to the Preferences section now and select SpeedChat Plus. Then use the Parent Password linked with your account to turn this feature on.
</ul>
<b>How to use SpeedChat Plus:</b>
<ul>
<li>Once SpeedChat Plus has been enabled, you can start using SpeedChat Plus in-game by typing words on your keyboard -- or -- by clicking on the blue "Type Chat" button in the upper-left corner of the play screen. Your messages are viewable to all who have SpeedChat Plus enabled within your vicinity. If you are whispering to a specific player, only that player will see your message.
<br><br><b>*** NOTE ***</b> currently if you try to Whisper to a player, the blue "Type Chat" button in the Whisper chat panel is disabled.  This will be fixed in the next release.
</ul>
...
<br><br>
<b>Special note for Open Chat with True Friends players:</b>
<br><br>
...
<ul>
<li>If the player you are chatting with has SpeedChat Plus, they will only see words from the Disney SpeedChat Plus dictionary. Words not in the dictionary will be replaced with animal sounds.
<br><br>
<li>If the player you are chatting with is your True Friend, your can chat openly through Open Chat with True Friends. When chatting openly with multiple True Friends at once, your chat may be viewable to other non-True Friend players who have SpeedChat Plus within your vicinity, provided the words are in the Disney SpeedChat Plus dictionary. Open Chat with True Friends whispers will only be viewable by the True Friend you are whispering to.
<br><br>
<b>*** NOTE ***</b> currently Open Chat with True Friends' Whispers does not work correctly, wherein all typed words are showing up as animal sounds.  This will be fixed in the next release.
</ul>

<br>
<hr>

<b>November 11, 2008 [sv1.0.36.10.test]</b>
<ul>
<li>Improved the look of the ToonHQ exterior in Donald's Dock playground and streets.
</ul>
<br>

<b>October 31, 2008 [sv1.0.36.9.test]</b>
<ul>
<li>Further fixes for crashes which occur when Toons are in transition (teleport, logging, tunnels etc) as day/night cycles.
</ul>
<br>

<b>October 29, 2008 [sv1.0.36.8.test]</b>
<ul>
<li>Fixed several bugs which lead to server instability during day/night transitions.
</ul>
<br>

<b>October 28, 2008 [sv1.0.36.7.test]</b>
<ul>
<li>This is a maintenance release.
</ul>
<br>

<b>October 26, 2008 [sv1.0.36.6.test]</b>
<ul>
<li>This is a maintenance release.
</ul>
<br>

<b>October 21, 2008 [sv1.0.36.5.test]</b>
<ul>
<li>Fixed crash bug which occurs when a player who has not finished downloading all of Toontown clicks on another Toon to bring up the Toon Panel.
<li>Fixed crash that happens when a player with the Limited True Friends setting enters a True Friend code without the "TT" prefix.
<li>Players playing with the ActiveX client (login via website and not the Launcher) will now be correctly asked for their password when trying to delete a Toon.
</ul>
<br>

<b>October 15, 2008 [sv1.0.36.4.test]</b>
<ul>
<li>This is a maintenance release.
</ul>
<br>
...
<div align=center><img src="/shared/images/dingbats/gear.gif" width="69" height="61"></div>
    ...
    <!--End Mid Content-->
     ...
     <td width="154" rowspan="1" valign="top" align="center">
       ...
       <!--
         flashObj=new FlashObj(
           "/shared/images/flash/topToons.swf?theDate=02262009&amp;topToonURL=/shared/images/dynamic/topToonImages/2009_02_26_small/&amp;imageBaseURL=/shared/images&amp;moreTopToonsURL=./topToons.php&amp;imageFileURL=/dynamic/topToonImages/2009_02_26_small/", // swf
           "154", //width
           "330", // height
           "#ffffff", // background
           "", // version
       ...
       <!--
         flashObj=new FlashObj(
           "/shared/images/flash/poll_small.swf?basePollPath=/shared/www/&amp;pollId=362&amp;alreadyAnswered=false&amp;pollType=undefined", // swf
           "154", //width
           "208", // height
           "#ffffff", // background
           "", // version
