...
<table cellspacing="0" cellpadding="0" border="0" width="434">
  <tr>
    ...
    <td align="right"><span class="bold">1 of <a href="comingSoon_1_2.php">2</a></span></td>
  </tr>
  <tr>
    <td colspan="2" class="txtSmall">Issue 1, February 20, 2003</td>
  </tr>
  <tr>
    <td colspan="2" align="center"><br><img src="/shared/images/cogsinvade.gif" width="427" height="40" alt="Cogs Invade Toontown!" border="0"><br><br></td>
  </tr>
  <tr>
    <td align="center" valign="top">
      ...
      <table width="200" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center">
            <p align="justify">The battle on the streets of Toontown is about to become more intense and exciting than ever! Special intelligence reports from Toontown HQ are warning of coordinated attacks that are expected to arrive soon. Reports have confirmed that the streets of Toontown will be raided by swarms of high-level COGs. Legal Eagles, Corporate Raiders, Big Cheeses and others are leaving their comfortable office buildings to join the street battles. Why these attacks occur is unknown at this time, but they are expected to last from several minutes to several hours.</p>
          </td>
        </tr>
      </table>
      <!-- START COLUMN 1 -->
    ...
    <td align="center" valign="top">
      ...
      <table width="200" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center"><img src="/shared/images/cogImage.jpg" width="200" height="150" alt="" border="0"><br><br></td>
        </tr>
        <tr>
          <td align="center">
            <p align="justify">All Toons are needed to stop these random attacks! Toon HQ has authorized double experience points for all gags used during these invasions. That's right, every pie thrown or anvil dropped will count for two!
            <br><br>
            Keep your eyes on the sky and prepare to help - the COG invasions are coming!!!</p>
          </td>
        </tr>
      </table>
      <!-- END COLUMN 2 -->
  ...
  <tr>
    <td colspan="2" align="center">
      <br><br>
      <a href="comingSoon_1_2.php"><img src="/shared/images/nextButton.jpg" width="92" height="25" alt="Next" border="0"></a>
    </td>
  </tr>
  <tr>
...
<!-- END MIDDLE CONTENT -->
    ...
    <!--End Mid Content-->
     ...
     <td width="154" rowspan="1" valign="top" align="center">
       ...
       <!--
         flashObj=new FlashObj(
           "/shared/images/flash/topToons.swf?theDate=01312011&amp;topToonURL=/shared/images/dynamic/topToonImages/2011_01_31_small/&amp;imageBaseURL=/shared/images&amp;moreTopToonsURL=./topToons.php&amp;imageFileURL=/dynamic/topToonImages/2011_01_31_small/", // swf
           "154", //width
           "330", // height
           "#ffffff", // background
           "", // version
...
<div id="tt_footer" align="center">
  ...
  <script type="text/javascript">
    ...
    cto.h.pageName='_comingSoon_1_1';
