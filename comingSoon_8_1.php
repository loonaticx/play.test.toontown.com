...
<table cellspacing="0" cellpadding="0" border="0" width="434">
  <tr>
    <td><span class="bold">TOONTOWN NEWSFLASH</span></td>
    <td align="right"><span class="bold">1 of 1</span></td>
  </tr>
  <tr>
    <td colspan="2" class="txtSmall">Issue 8, November 5, 2003</td>
  </tr>
  <tr>
    <td colspan="2" align="center"><br>
      <img src="/shared/images/newsimages/headline_comingSoon_8_arrived.gif" width="330" height="34" alt="The Fish Have Arrived!" border="0">
      <img src="/shared/images/newsimages/fishgroupshot.jpg" width="433" height="187" alt="" border="0"><br><br>    
      <div align="left" style="margin-top:0px;margin-bottom:10px;margin-left:9px;margin-right:0px;">
        <p align="justify">New fish species have migrated to Toontown and are in need of a good home!  Toons can help do their part by catching and selling them in exchange for Jellybeans to the Pet Shop representatives at fishing holes all across town.  New ponds along the streets in every neighborhood will be stocked with silly sea life. The bigger and more rare the fish, the more Jellybeans it is worth!</p>
      </div>
    </td>  
  </tr>
  <tr>
    <td align="center" valign="top">    
      ...
      <table width="200" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center">
            <p align="justify"><br>
              <img src="/shared/images/newsimages/donaldsDock.jpg" width="202" height="164" alt="" border="0">
              <br><br>
              New fishing rods for sale on the Cattlelog will help you snag those sneaky snorkelers.  Before a line is cast you must use your extra Jellybeans to bait your rod or the fish won�t bite! Better rods will help catch the heavier fish but cost more beans to bait.</p> 
              <br>
          </td>
        </tr>
      </table>
    ...
    <td align="center" valign="top">
      ...
      <table width="200" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center">
            <br>  
            <p align="justify">Remember, different varieties thrive in different environments. The King Crab can be found in the serene harbor of Donald�s Dock while the Alaskan Crab prefers the brisk waters of the Brrrgh.  The Old King Crab is a rare breed that can only be found on Lighthouse Lane.</p><br>
            <img src="/shared/images/newsimages/clownFish.jpg" width="200" height="202" alt="" border="0">
          </td>
        </tr>
      </table>
      <!-- END COLUMN 2 -->
  ...
  <tr>
    <td colspan="2" align="center">
      <div align="left" style="margin-top:0px;margin-bottom:10px;margin-left:9px;margin-right:0px;">    
        <p align="justify">Beware! Becoming a maxed Toon just got more difficult! A new fishing page in your Shticker book helps you keep track of all the fish you have caught. As you make your way to becoming a master fisherman, you will be rewarded generously for collecting fish species. To mark your progress through your collection, you will be given five trophies each worth a one point Laff boost which means the max Laffpoints will be 105! As an added bonus, underwater treasure chests filled with Jellybeans are waiting to be recovered!</p>    
      </div>
      <br>
      <a href="./newsArchive.php">Look at past issues</a>
    </td>
  </tr>
</table>
<!-- END MIDDLE CONTENT -->
...
<div id="tt_footer" align="center">
  ...
  <script type="text/javascript">
    ...
    cto.h.pageName='_comingSoon_8_1';
