...
<table width="434" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="2" align="center">
      <img src="./events/images/TT_40_laff-off_pig_lg.jpg" width="424" height="346" alt="40 Laff-Off Event" border="0">
    </td>
  </tr>
  <tr>
    <td colspan="2">
      For the entire month of March, Toontown is playing host to the 40 Laff-Off Event! Between March 1 and March 31, create a new Toon - even a Pig - and reach 40 Laff points the fastest (in-game elapsed time) to win a Toontastic prize. The four fastest Members to reach 40 Laff points will each win an Apple 17" 2.0GHz iMac of their very own! 
      <br><br>
      Your time is measured from the moment your new Toon enters the game to the moment he or she exits. Play for 1 hour a day or 10 hours straight -- your time is only measured while you are in-game. And once you've reached 40 Laff points with one Toon, you can create another to try for best time again. (Only one iMac will be awarded per account.)       
    </td>
  </tr>
    ...
    <td width="434" align="center" colspan="2">
      <div style="width:434" align="justify">
        <span style="float: left">
          <img src="./events/images/TT_events_granprixgraphic.gif" width="200" height="149" alt="Toontown Grand Prix" border="0">            
        </span>
          <img src="./events/images/TT_events_granprixtitle.gif" width="191" height="24" alt="Toontown Grand Prix" border="0"><br>
    ...
    <td width="434" align="center" colspan="2">
      <div style="width:434" align="left">
        <span style="float: right">
          <a href="./playersguide/PGPage.php?pg=55"><img src="./events/images/TT_events_bingowedgraphic.gif" width="187" height="141" alt="Play Bingo!" border="0"></a>            
        </span>
          <img src="./events/images/TT_events_bingowedtitle.gif" width="176" height="27" alt="Bingo Wednesdays" border="0"><br>
          <span class="subtitle">Team up at the ponds every Wednesday for Bingo!</span><br>
          Work together with the other Toons at the pond. If you complete the card before the clock runs out, you win lots of jellybeans. Read about Bingo Wednesdays in the <a href="./playersguide/PGPage.php?pg=55">Official Player's Guide</a> now.
      </div>
    </td>
  </tr>
</table>
