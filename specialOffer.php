...
<table cellspacing="0" cellpadding="0" border="0" width="434">
  <tr>
    <td colspan="3" align="center">
      <img src="/shared/images/purchase/sonewmembers.gif" width="345" height="55" alt="Special Offer! For New Members" border="0">
    </td>
  </tr>
  <tr>
    <td colspan="3" align="center">
      <img src="/shared/images/purchase/495.gif" width="444" height="51" alt="Join Toontown now with this limited special offer for new members! Get your first month of Toontown for only $4.95 (that's almost half off your first month!)" border="0">
    </td>
  </tr>
  <tr>
    <td colspan="3" align="center" class="offer">
      <br>
      SIGN UP NOW AND GET YOUR EXCLUSIVE TOONTOWN MEMBERSHIP
      <br><br>
    </td>
  </tr>
  <tr>
    <td valign="top">
      <img src="/shared/images/special_offer_screenshots.jpg" width="150" height="187" alt="" border="0">
    </td>
    <td colspan="2" valign="top">
      <br>
      <span class="bold">Adventure</span> on hundreds of tasks to earn more Gags and Laff points!
      <br><br>
      <span class="bold">Participate</span> in special events and contests with other Toons!
      <br><br>
      <span class="bold">Personalize</span> your Toon with cool clothes and decorate your Toon's own house!
    </td>
  </tr>
  <tr>
    <td colspan="3" align="center">
      <img src="/shared/images/billboards/swag.jpg" width="434" height="155" alt="Trading Cards!  Newsletters!  Posters!" border="0">
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="3" align="center" class="offer">
      This special offer is only for a limited time, so don't delay.
      <br>
      Sign up today!
    </td>
  </tr>
  <tr>
    <td colspan="3" align="center">
      <br>
            <a href="./unavailableOnTestServer.php"><img src="/shared/images/buttons/but_joinnow.jpg" width="146" height="36" alt="Join Now!" border="0"></a>
    </td>
  </tr>
</table>
    ...
    <!--End Mid Content-->
     ...
     <td width="154" rowspan="1" valign="top" align="center">
       ...
       <!--
         flashObj=new FlashObj(
           "/shared/images/flash/topToons.swf?theDate=12082008&amp;topToonURL=/shared/images/dynamic/topToonImages/2008_12_08_small/&amp;imageBaseURL=/shared/images&amp;moreTopToonsURL=./topToons.php&amp;imageFileURL=/dynamic/topToonImages/2008_12_08_small/", // swf
           "154", //width
           "330", // height
           "#ffffff", // background
           "", // version
       ...
       <!--
         flashObj=new FlashObj(
           "/shared/images/flash/poll_small.swf?basePollPath=/shared/www/&amp;pollId=351&amp;alreadyAnswered=false&amp;pollType=displayed", // swf
           "154", //width
           "208", // height
           "#ffffff", // background
           "", // version
